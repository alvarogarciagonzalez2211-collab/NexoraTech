    ...
    <main className="bg-[#FFFFFF] text-[#2B2B2B] min-h-screen font-sans selection:bg-[#00D084] selection:text-white">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto border-b border-gray-100">
        ...
        <div className="hidden md:flex space-x-8 text-[#2B2B2B] items-center font-semibold">
          <a href="#servicios" className="hover:text-[#1E73BE] transition">Servicios</a>
      ...
      <header className="py-24 px-6 text-center max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          <button className="bg-[#00D084] text-white hover:scale-105 px-10 py-4 rounded-xl font-bold text-lg transition-all shadow-lg shadow-[#00D084]/20">
            Empezar proyecto
          </button>
          <button className="border-2 border-[#2B2B2B] text-[#2B2B2B] hover:bg-[#2B2B2B] hover:text-white px-10 py-4 rounded-xl font-bold text-lg transition-all">
            Ver servicios
          </button>
        </div>
      </header>
